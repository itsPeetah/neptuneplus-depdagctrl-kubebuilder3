...
type MetricGetter interface {
	PodMetrics(p *corev1.Pod, metricType MetricType) (*metricsv1beta2.MetricValue, error)
	ServiceMetrics(s *corev1.Service, metricType MetricType) (*metricsv1beta2.MetricValue, error)
}
...
func (d *DefaultGetter) PodMetrics(p *corev1.Pod, metricType MetricType) (*metricsv1beta2.MetricValue, error) {
...
// PodMetrics retrieves the Pod metrics. metrics.All is not supported at the moment by metrics-exposer so don't use it
func (d *DefaultGetter) ServiceMetrics(s *corev1.Service, metricType MetricType) (*metricsv1beta2.MetricValue, error) {
...
func (d *FakeGetter) PodMetrics(p *corev1.Pod, metricType MetricType) (*metricsv1beta2.MetricValue, error) {
...
// PodMetrics retrieves the Pod metrics. metrics.All is not supported at the moment by metrics-exposer so don't use it
func (d *FakeGetter) ServiceMetrics(s *corev1.Service, metricType MetricType) (*metricsv1beta2.MetricValue, error) {
	return &metricsv1beta2.MetricValue{
		Value: *resource.NewQuantity(d.ResponseTime, resource.BinarySI),
	}, nil
}
